   ...
   public class CommunicationManager 
    {
        ...
        private Label _displayCallNumber;
        ...
        public Label DisplayCallNumber
        {
            get { return _displayCallNumber; }
            set { _displayCallNumber = value; }
        }
        ...
        public void WriteData(string msg)
        {
            switch (CurrentTransmissionType)
            {
                case TransmissionType.Text:
                    ...
                    comPort.Write(msg + Convert.ToChar(13));
                    //display the message
        ...
        public bool OpenPort()
        {
            try
            {
                ...
                //now open the port
                comPort.Open();
                /*comPort.WriteData("AT" + Convert.ToChar(13));
                System.Threading.Thread.Sleep(1000);
                if (comPort.ReadExisting().IndexOf("OK") >= 1)
                {
                    MessageBox.Show("Modem Habilitado Para Comandos AT");
                }
                else
                {
                    MessageBox.Show("Modem No Habilitado para Comandos AT");
                }
                comPort.DiscardInBuffer();*/
                //display message
                DisplayData(MessageType.Normal, "Puerto Abierto a  " + DateTime.Now + "\n");
